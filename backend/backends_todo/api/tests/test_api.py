...
class TaskAPITestCase(APITestCase):
    ...
    def test_get_all_tasks(self):
        ...
        url = reverse('tasks-list')  # URL name from the router
    ...
    def test_get_single_task(self):
        ...
        url = reverse('tasks-detail', kwargs={'pk': self.task.id}) # URL for task detail
        response = self.client.get(url)
    ...
    def test_invalid_task_id(self):
        ...
        invalid_url = reverse('tasks-detail', args=[999])  # ID 999 doesn't exist
